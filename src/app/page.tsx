        ...
        <form onSubmit={handleLogin}>
          <div style={{marginBottom:'8px'}}>
            ...
            <input type="text" value={username} onChange={e => setUsername(e.target.value)}
              ...
              placeholder="tunombre" autoComplete="off" required />
          </div>
          ...
          {error && <p style={{color:'#f87171',background:'#2a0e0e',borderRadius:'8px',padding:'10px 12px',fontSize:'13px',marginBottom:'12px'}}>{error}</p>}
          <button type="submit" disabled={loading}
            ...
            {!loading && <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4ade80" strokeWidth="2.5"><polyline points="9 18 15 12 9 6"/></svg>}
          </button>
        </form>
      </div>
    </main>
